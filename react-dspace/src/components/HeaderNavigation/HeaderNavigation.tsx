...
const HeaderNavigation: React.FC = () => {
    ...
    const handleMenuOpen = (event: React.MouseEvent<HTMLElement>, linkId: number) => {
                        ...
                        <Box key={link.id} sx={{ position: 'relative', flexShrink: 0 }}>
                            ...
                            >
                                ...
                                {link.submenu && (
                                    <KeyboardArrowDown
                                        sx={{
                                            transform: openMenuId === link.id ? 'rotate(180deg)' : 'rotate(0deg)',
                                    ...
                                    {link.submenu.map((subLink) => (
                                        <MenuItem
                                            ...
                                            onClick={(e) => {
                                                e.preventDefault();
                                                e.stopPropagation();
                                                console.log('Submenu item clicked:', { id: subLink.id, path: subLink.path });
                                                handleNavigation(subLink.id, subLink.path);
                                            }}
                                            sx={{
                                                padding: '12px 16px',
                                                backgroundColor: activeLinkIdx === subLink.id ? '#e3f2fd' : 'transparent',
                                                '&:hover': {
                                        ...
                                        >
                                            <Typography
                                                sx={{
                                                    fontSize: '0.875rem',
                                                    fontWeight: activeLinkIdx === subLink.id ? 600 : 400,
                                                    color: '#333',
                                                }}
                                            >
                                                {subLink.title}
