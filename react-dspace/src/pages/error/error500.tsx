  ...
  return (
    <div className="error-container">
      ...
      <div className={`error-card ${show ? 'fade-in' : ''}`}>
        <h1 className="glow-text animate__animated animate__heartBeat">500</h1>
        ...
        <p className="animate__animated animate__fadeIn animate__delay-2s">
          Something broke on our end. Our team has been notified and is working on it.
        </p>

        <ul className="reason-list animate__animated animate__fadeInUp animate__delay-3s">
          <li>• Unexpected server crash</li>
          <li>• Database issues or outages</li>
          <li>• Unhandled application error</li>
        </ul>

        <div className="btn-group animate__animated animate__fadeInUp animate__delay-4s">
          <a className="space-btn secondary" href="/">🏠 Back to Home</a>
        </div>
      </div>
